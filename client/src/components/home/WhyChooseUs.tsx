...
import { BRAND_MESSAGE } from '../../seo/config'
    ...
    <RevealOnScroll>
      ...
      <div className="mx-auto w-[calc(100%-32px)] max-w-[1160px] md:w-[calc(100%-48px)]">
        <div className="mb-12 max-w-[600px]">
          ...
          <p className="mt-5 max-w-[490px] text-base leading-7 text-cream/70">We make it easier to find {BRAND_MESSAGE.toLowerCase()}.</p>
        </div>
