  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
           <div className="image-preview-panel y-scrollbar relative flex w-full max-w-5xl flex-col items-center overflow-y-auto rounded-2xl bg-cream p-3 shadow-2xl sm:p-5">
