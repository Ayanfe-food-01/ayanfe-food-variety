...
import type { QuoteDeliveryFeeOption, QuoteFulfillmentOption } from './constants'
  ...
  return (
    <section className="mt-5 rounded-2xl border border-line bg-white p-5 shadow-sm sm:p-6" aria-label="Prepare quotation">
      <div>
        ...
        <p className="mt-1 text-sm text-muted">Enter a quoted unit price for each requested item and set the delivery fee. Totals are calculated on the server and saved as a snapshot, so later catalog price changes never affect this quotation.</p>
      </div>
      ...
      <div className="mt-6 grid gap-5 lg:grid-cols-2">
        <QuoteDetailFulfillmentCard
          ...
          onDeliveryFeeModeChange={onDeliveryFeeModeChange}
