...
export const getGoogleAuthorizationUrl = (state, nonce) => {
...
export async function verifyGoogleAuthorizationCode(code, expectedNonce) {
    ...
    if (!idToken)
        throw new HttpError(401, 'Google sign-in did not return a valid identity.');
    let payload;
    try {
