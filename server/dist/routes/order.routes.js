...
import { getCustomerOrderReviewEligibilityController, submitCustomerReviewController, } from '../modules/reviews/review.controller.js';
...
orderRoutes.post('/', optionalCustomerAuthentication, requireCheckoutRequestHeader, createRateLimit(10, 15 * 60 * 1000), checkoutController);
