...
import type { OrderReviewEligibility, ReviewCreateInput, ReviewResponse } from './review.types.js'
...
export const toReviewResponse = (review: ReviewRow): ReviewResponse => ({
  id: review.id,
...
export const orderQualifiesForReview = (order: { paymentStatus: PaymentStatus; orderStatus: OrderStatus; archivedAt: Date | null }): boolean =>
...
const toEligibilityItem = (
  ...
  qualifies: boolean,
): OrderReviewEligibility['items'][number] => {
