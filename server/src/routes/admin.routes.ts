...
import { changeAdminPasswordController } from '../controllers/auth.controller.js'
import {
  brandingImageUpload,
...
} from '../controllers/quote.admin.controller.js'
import {
...
} from '../controllers/review.admin.controller.js'
import {
...
adminRoutes.get('/delivery-locations/states', listAdminDeliveryLocationStatesController)